...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function l(e, t) {
        for (var o = {
            ...
            S(r) && !n && (console.log(["%c%cUh-oh. It looks like you broke something that was previously working.", "", "Fix it before proceeding.", "", "See below for what step is no longer working.", ""].join("\n"), "font-weight:bold", "color:#c00"),
            e > 2 && i({
                mocha: !0
            }, function() {}),
            n = !0,
    ...
    function F() {
        //return N([6011, 644, 645, 646, 647, 648, 649, 65], [16, 19])//trying to understand N() and taking out test cases
        return !0
    }
    function L() {
    ...
    var z, J = sinon.spy(window, "detectNetwork"), Q = !1, X = [{
        print: u,
        test: j.bind(null, 1),
        mocha: !1
    }, {
